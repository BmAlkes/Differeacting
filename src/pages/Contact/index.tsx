        ...
        <div className="bg-[#030B0F] pb-16">
          ...
          >
            <div className="text-center px-6">
              ...
              <p className="text-lg text-white my-9">
                  ...
                  <div className="grid sm:grid-cols-2 gap-8 ">
                    ...
                    <div className="relative flex items-center">
                      <input
                        ...
                        className="px-7  py-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#6FCFED] outline-none"
                        value={phone}
                    ...
                    <div className="relative flex items-center sm:col-span-2">
                      <textarea
                        ...
                        className="px-7  pt-3 bg-white resize-none text-black w-full text-sm border-b-2 focus:border-[#6FCFED] outline-none"
                        value={message}
