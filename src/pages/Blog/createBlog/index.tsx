...
const CreatePost = () => {
  ...
  const onSubmit = (data: PostFormData) => {
    ...
    mutate(formData as any); // Using 'any' here as a temporary workaround for the FormData type issue
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto p-6">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-[#6FCFED] ">
              Create New Post
            </h1>
          ...
          <Link
            to="/dashboard/blog"
            className="bg-white px-6 py-2 rounded-lg shadow-sm border border-gray-200 hover:border-[#73cce3] transition-colors duration-200 text-gray-700 hover:text-[#73cce3]"
          >
            Back to Blog
          </Link>
        </div>
...
/>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-blue-500 text-white py-3 rounded-lg font-medium hover:from-purple-700 hover:to-blue-600 transition-all duration-200 disabled:opacity-50"
            >
