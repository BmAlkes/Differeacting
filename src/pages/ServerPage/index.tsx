  ...
  return (
    ...
    >
      <section className=" bg-[#030B0F] lg:h-screen h-full mt-[96px] relative">
        <div
          className="h-full flex flex-col lg:flex-row items-center lg:justify-between  gap-[80px] "
          data-aos="fade-down"
        ...
        >
          ...
          />
          <div className=" flex flex-col justify-center items-start  z-50 lg:mr-40">
            <h3 className="text-[#f1fafd] lg:text-2xl text-lg font-bold text-center pt-5">
              פתחו את שערי הדיגיטל שלכם עם אתרי אינטרנט מותאמים אישית
            </h3>
            <h2 className="text-[#f4f4f4] font-bold lg:text-[102px] text-[40px] text-center md:text-right   ">
              אחסון והקצאת שרתים
            </h2>
          ...
          <div className="flex justify-center items-center ">
            <img
              ...
              className=" w-full rounded-[20px] z-10 mb-12"
            />
          </div>
        </div>
      </section>
      ...
      <section className=" bg-[#030B0F] lg:h-screen h-full relative p-3">
        <img
          src="https://res.cloudinary.com/landingpage2/image/upload/v1726125355/Differeacting/gy-rRih3DFPcFHQ0p-7BP-transformed_n4ekcz.png"
          alt="creadible image"
          className="lg:max-w-[900px] centralImage  z-[-10px]"
        />
        <div className="container flex items-center justify-between h-full">
          <div className="text-white z-10 container mx-auto p-9 ">
            <h2 className="md:text-7xl text-2xl text-center mb-4">
              ביצוע שינוי מתחיל משיחה אחת
            </h2>
            <p className="text-center text-lg mb-12">
              מלא את הטופס למטה כדי שנציג שירות יחזור אליך בהקדם
            </p>
