...
import digital from "../../assets/server.jpg";
    ...
    >
      <section className=" bg-[#030B0F] lg:h-screen h-full mt-[96px] relative">
        ...
        >
          ...
          />
          <div className="max-w-[700px] flex flex-col justify-center items-center lg:items-start z-50">
      ...
      <section className="w-full  h-full flex flex-col items-center">
        ...
        <p className="mx-auto text-center max-w-[441px] text-[#5D5D5D]text-lg hidden">
