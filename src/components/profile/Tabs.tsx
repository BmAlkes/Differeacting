...
const tabs = [
    ...
    { name: 'Change Password', href: '/dashboard/profile/password', icon: FingerPrintIcon },
]
        ...
        <div className='mb-10'>
            ...
            <div className="hidden sm:block">
                <div className="border-b border-gray-200">
                    <nav className="w-full flex justify-start flex-row-reverse  gap-5  -mb-px  space-x-8" aria-label="Tabs">
                        {tabs.map((tab) => (
                            <Link
                                key={tab.name}
                                to={tab.href}
