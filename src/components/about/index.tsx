    ...
    <>
      ...
      <section className="w-full py- h-full bg-[#030B0F] text-[#D1D1D1] flex flex-col justify-center items-center relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 container gap-8 mt-20 mb-14 lg:mb-0  z-50">
          <div className="flex flex-col min-w-[505px]   justify-between py-6  px-4 rounded-lg show ">
          ...
          <div className="flex flex-col min-w-[315px]   justify-between py-6 px-4 rounded-lg show">
            ...
            <p className="text-lg font-normel text-[#888888] my-5 text-justify">
            מחלקת האחסון והתחזוקה שלנו מספקת פתרונות מקיפים להבטחת הביצועים, האבטחה והיציבות של האתר שלך. אנו משתמשים בשרתים מתקדמים ובטכנולוגיות ענן כמו AWS או Google Cloud, המבטיחים זמני טעינה מהירים וזמינות גבוהה. מערכות האבטחה שלנו כוללות SSL מתקדם, הגנה מפני DDoS ומעקב אבטחה 24/7. אנו מבצעים גיבויים אוטומטיים ועדכוני תוכנה שוטפים, ומספקים ניטור ביצועים מתמיד. שירותי התחזוקה שלנו מבטיחים שהאתר שלך תמיד יהיה מעודכן, מאובטח ומוכן לספק את החוויה הטובה ביותר ללקוחותיך, מה שמוביל לשיפור בשיעורי ההמרה ולהגדלת האמון של הלקוחות במותג שלך.
            </p>
            <div className="hiddenShow">
              <Link to="server">
                <button className=" button bg-gradient-to-r from-[#6FCFED] to-[#C96CBE] py-[2px] px-[2px]  text-white font-semibold rounded p-[1px] md:block  mr-auto">
