...
document.body.dir = "ltr"
  ...
  if(data) return (
    ...
    <>
        <section className="w-full  bg-gray-200 h-screen bg-[url('https://res.cloudinary.com/landingpage2/image/upload/v1732558718/5000x5000-4_1_j6ngaz.jpg')] bg-no-repeat bg-center  relative">
        <Sidebar/>
