...
document.body.dir = "ltr"
  ...
  if(data) return (
    ...
    <>
        <section className="w-full  bg-gray-200 h-screen bg-[url('https://res.cloudinary.com/landingpage2/image/upload/v1732303053/5000x5000-4_q0s4rj.png')] bg-no-repeat bg-center relative">
        <Sidebar/>
